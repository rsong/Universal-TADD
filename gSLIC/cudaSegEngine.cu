#include "cudaSegEngine.cuh"
#include "cudaUtil.cuh"
#include "cudaImgTrans.cuh"
#include "cudaSegSLIC.cuh"
...
__device__ int* avgBuffer;
__device__ uchar4* valBuffer;
__device__ int* pixBuffer;
__device__ int* pixMatrix;
__device__ int* sumMatrix;

int nWidth,nHeight,nSeg,nMaxSegs;
int lWidth,lHeight, nSegs;
int pWidth,pHeight;
